...
<head>
    ...
    <title>Health Application System</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">New Applications</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            *click on the row to approve
                        </div>
                        <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-dark" style="margin: 0;">Email</p>
                    <p class="text-muted" id="clinicemail" style="font-size: 14px;">The content of your modal.</p>
                    <input type="hidden" id="clinicid" />
                </div>
                <div class="modal-footer"><button class="btn btn-light" type="button" data-dismiss="modal">Close</button><button class="btn btn-primary" id="btnapprove" type="button" onclick="approve_clinic()">Approve</button></div>
            </div>
        </div>
    </div>
    <!--end of modal-->
    ...
    function view_details(id) {
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#clinicemail").html(data[0].cemail)
    ...
    function approve_clinic() {
        $.ajax({
            ...
            data: {
                op: "approveclinic",
                id: $("#clinicid").val(),
                email: $("#clinicemail").html(),
            },
            success: function(res) {
                alert(res);
                if (res == "OK") {
                    alert("Notification email sent to client")
                    $("#clinicmodal .close").click();
                    load_clinics();
                }
            }
